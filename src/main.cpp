...
template <typename Allocator>
void fill_list(homework3::ForwardList<int, Allocator>& list)
{
...
int main()
{
    ...
    std::map<int, int, std::less<int>, homework3::Allocator<std::pair<const int, int>, 10>> map_my_alloc;
    homework3::ForwardList<int> list_std_alloc;
    homework3::ForwardList<int, homework3::Allocator<int, 10>> list_my_alloc;
